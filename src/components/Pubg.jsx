        ...
        <div>
          ...
          <div className="container px-4 px-lg-5 my-5">
              <div className="row gx-4 gx-lg-5 align-items-center">
                <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/pubg.png" alt="..." /></div>
                <div className="col-md-6">
                  {/* <div className="small mb-1">SKU: BST-498</div> */}
                  <h1 className="display-5 fw-bolder">PUBG</h1>
                  {/* Product reviews*/}
                  ...
                  <p className="lead">Tingkatkan keterampilan bertahan hidup Anda di PUBG bersama pelatih DisNatt! Pelajari strategi rotasi, penguasaan senjata, dan taktik bertarung yang akan membantu Anda menguasai setiap medan pertempuran. Dengan bimbingan ahli kami, Anda akan memahami cara bermain secara taktis, membuat keputusan cepat, dan beradaptasi dengan situasi yang terus berubah. Bergabunglah dengan kelas coaching kami dan bawa permainan PUBG Anda ke level berikutnya!</p>
                  <div className="d-flex">
                    <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="https://api.whatsapp.com/send?phone=6281358622017&text=Hallo kak saya mau coaching PUBG">Join Class</a></div>
                  </div>
                </div>
              </div>
            </div>
