        ...
        <div>
          ...
          <div className="container px-4 px-lg-5 my-5">
              <div className="row gx-4 gx-lg-5 align-items-center">
                <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/dl.png" alt="..." /></div>
                <div className="col-md-6">
                  {/* <div className="small mb-1">SKU: BST-498</div> */}
                  <h1 className="display-5 fw-bolder">Dead Lock</h1>
                  {/* Product reviews*/}
                  ...
                  <p className="lead">Bergabunglah dengan sesi coaching Deadlock di DisNatt, di mana kami membantu Anda menguasai game third-person shooter intens ini. Deadlock menampilkan pertandingan 6v6 yang menggabungkan elemen hero shooter dan MOBA, menuntut strategi tinggi dan kerja sama tim. Pelatih ahli kami akan membimbing Anda dalam menguasai kontrol jalur (lane), memaksimalkan kemampuan hero, dan menguasai peta untuk keuntungan kompetitif.</p>
                  <div className="d-flex">
                    <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="https://api.whatsapp.com/send?phone=6281358622017&text=Hallo kak saya mau coaching Dead Lock">Join Class</a></div>
                  </div>
                </div>
              </div>
            </div>
