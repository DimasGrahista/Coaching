          ...
          <section className="py-5">
            <div className="container px-4 px-lg-5 my-5">
              <div className="row gx-4 gx-lg-5 align-items-center">
                <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/thesims.png" alt="..." /></div>
                <div className="col-md-6">
                  <div className="small mb-1">SKU: BST-498</div>
                  <h1 className="display-5 fw-bolder">The Sims</h1>
                  <div className="fs-5 mb-5">
                    <span className="text-decoration-line-through">Rp210.000</span>
                    <span> Rp99.000</span>
                  </div>
                  <p className="lead">Kuasai dunia The Sims dengan bimbingan dari pelatih DisNatt! Pelajari cara merancang rumah impian, membangun kehidupan sosial yang dinamis, dan mengelola karier Sim Anda dengan sempurna. Dengan panduan kami, Anda bisa menciptakan pengalaman bermain yang lebih kreatif dan strategis, serta memahami mekanika game secara lebih mendalam. Bergabunglah dengan kelas coaching kami untuk mengeksplorasi potensi penuh Anda di dunia The Sims!</p>
                  <div className="d-flex">
                    <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="/valo">Join Class</a></div>
                  </div>
                </div>
              </div>
            </div>
