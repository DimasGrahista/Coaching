            ...
            <div className="container px-4 px-lg-5 my-5">
              <div className="row gx-4 gx-lg-5 align-items-center">
                ...
                <div className="col-md-6">
                  ...
                  <h1 className="display-5 fw-bolder">About Us</h1>
                  {/* <div className="fs-5 mb-5">
                    <span className="text-decoration-line-through">$45.00</span>
                    <span>$40.00</span>
                  </div> */}
                  <p className="lead">DisNatt adalah platform coaching untuk games FPS dan lain sebagainya. Kami menyediakan pelatih profesional untuk membantu Anda meningkatkan keterampilan, strategi, dan mentalitas dalam permainan. Apapun level Anda, kami siap mendukung perjalanan Anda menuju kehebatan di dunia esports!</p>
