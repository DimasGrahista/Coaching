          ...
          <div>
            ...
            <div className="container px-4 px-lg-5 my-5">
                <div className="row gx-4 gx-lg-5 align-items-center">
                  <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/apex-01.png" alt="..." /></div>
                  <div className="col-md-6">
                    {/* <div className="small mb-1">SKU: BST-498</div> */}
                    <h1 className="display-5 fw-bolder">Apex Lagend</h1>
                    {/* Product reviews*/}
                    ...
                    <div className="fs-5 mb-5">
                      <span className="text-decoration-line-through">Rp650.000</span>
                      <br/><span>Rp150.000-Rp500.000</span>
                    </div>
                    <p className="lead">Tingkatkan kemampuan Anda di Valorant bersama pelatih profesional DisNatt! Pelajari strategi cerdas, penguasaan agen, dan keterampilan menembak presisi yang diperlukan untuk mendominasi di setiap pertandingan. Dengan bimbingan ahli kami, Anda bisa memahami lebih dalam cara bermain secara taktis, membuat keputusan cepat, dan memaksimalkan potensi Anda. Bergabunglah dengan kelas coaching kami dan bawa permainan Valorant Anda ke level berikutnya!</p>
                    <div className="d-flex">
                      <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="https://api.whatsapp.com/send?phone=6281358622017&text=Hallo kak saya mau coaching Valorant">Join Class</a></div>
                    </div>
                  </div>
                </div>
              </div>
