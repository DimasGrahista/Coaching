        ...
        <div>
          ...
          <section className="py-5">
            <div className="container px-4 px-lg-5 my-5">
              <div className="row gx-4 gx-lg-5 align-items-center">
                <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/rsix.png" alt="..." /></div>
                <div className="col-md-6">
                  <div className="small mb-1">SKU: BST-498</div>
                  <h1 className="display-5 fw-bolder">Rainbow Six Siege</h1>
                  {/* Product reviews*/}
                  ...
                  <div className="fs-5 mb-5">
                    <span className="text-decoration-line-through">Rp210.000</span>
                    <span> Rp99.000</span>
                  </div>
                  <p className="lead">Tingkatkan keterampilan taktis Anda di Rainbow Six Siege bersama pelatih DisNatt! Pelajari strategi serangan dan pertahanan, penguasaan berbagai operator, serta cara berkomunikasi efektif dalam tim. Dengan bimbingan ahli kami, Anda akan memahami mekanika permainan dan taktik yang diperlukan untuk mendominasi setiap ronde. Bergabunglah dengan kelas coaching kami dan jadilah pemain yang lebih strategis dan terampil di dunia Rainbow Six Siege!</p>
                  <div className="d-flex">
                    <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="https://api.whatsapp.com/send?phone=6281358622017&text=Hallo kak saya mau coaching Rainbow Six" target='_blank'>Join Class</a></div>
                  </div>
                </div>
              </div>
            </div>  
          ...
          <section className="py-5 bg-light">
            <div className="container px-4 px-lg-5 mt-5">
              <h2 className="fw-bolder mb-4">Other Coaching</h2>
              <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div className="col mb-5">
                  <div className="card h-100">
                    ...
                    {/* Product actions*/}
                    <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                      <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="#">View Option</a></div>
                    </div>
                  </div>
                </div>
                <div className="col mb-5">
