          ...
          <div>
            ...
            <div className="container px-4 px-lg-5 my-5">
                <div className="row gx-4 gx-lg-5 align-items-center">
                  <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src="./img/cs2.png" alt="..." /></div>
                  <div className="col-md-6">
                    {/* <div className="small mb-1">SKU: BST-498</div> */}
                    <h1 className="display-5 fw-bolder">Counter-Strike 2</h1>
                    {/* Product reviews*/}
                    ...
                    <p className="lead">Tingkatkan skill Anda di Counter-Strike 2 dengan bimbingan dari pelatih DisNatt! Pelajari strategi bermain yang efektif, penguasaan peta, dan teknik tembakan yang akan membantu Anda mendominasi lawan. Dengan dukungan ahli kami, Anda akan memahami dinamika tim, komunikasi yang efektif, dan cara memanfaatkan setiap senjata dengan optimal. Bergabunglah dengan kelas coaching kami dan bawa permainan Counter-Strike 2 Anda ke level yang lebih tinggi!</p>
                    <div className="d-flex">
                      <div className="text-center"><a className="btn btn-outline-dark mt-auto" href="https://api.whatsapp.com/send?phone=6281358622017&text=Hallo kak saya mau coaching Cs2">Join Class</a></div>
                    </div>
                  </div>
                </div>
              </div>
